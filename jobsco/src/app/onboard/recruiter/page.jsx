...
import { Briefcase, User, Building, Calendar, Phone, Mail, Linkedin, MapPin, Upload, ChevronRight } from 'lucide-react'
...
const formSchema = z.object({
  ...
  joinedYear: z.string().regex(/^\d{4}$/, { message: "Please enter a valid year." }),
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-4xl shadow-2xl bg-white/80 backdrop-blur-sm">
        <CardHeader className="text-center space-y-1">
          <CardTitle className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">Complete Your Profile</CardTitle>
          <CardDescription className="text-lg">Let's get to know you better</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Acme Inc." {...field} className="bg-white/50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Senior Recruiter" {...field} className="bg-white/50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="https://linkedin.com/in/johndoe" {...field} className="bg-white/50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
